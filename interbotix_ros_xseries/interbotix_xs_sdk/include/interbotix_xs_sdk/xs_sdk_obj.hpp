...
private:
  ...
  void robot_srv_torque_enable(const std::shared_ptr<rmw_request_id_t> request_header, std::shared_ptr<TorqueEnable::Request> req, std::shared_ptr<TorqueEnable::Response> res);
  ...
  /// @details - refer to the service definition for details
  void robot_srv_reboot_motors(const std::shared_ptr<rmw_request_id_t> request_header, std::shared_ptr<Reboot::Request> req, std::shared_ptr<Reboot::Response> res);
  ...
  /// @details - refer to the service definition for details
  void robot_srv_get_robot_info(const std::shared_ptr<rmw_request_id_t> request_header, std::shared_ptr<RobotInfo::Request> req, std::shared_ptr<RobotInfo::Response> res);
  ...
  /// @details - refer to the service definition for details
  void robot_srv_set_operating_modes(const std::shared_ptr<rmw_request_id_t> request_header, std::shared_ptr<OperatingModes::Request> req, std::shared_ptr<OperatingModes::Response> res);
  ...
  void robot_srv_set_motor_pid_gains(const std::shared_ptr<rmw_request_id_t> request_header, std::shared_ptr<MotorGains::Request> req, std::shared_ptr<MotorGains::Response> res);
  ...
  /// @details - refer to the service definition for details
  void robot_srv_set_motor_registers(const std::shared_ptr<rmw_request_id_t> request_header, std::shared_ptr<RegisterValues::Request> req, std::shared_ptr<RegisterValues::Response> res);
  ...
  /// @details - refer to the service definition for details
  void robot_srv_get_motor_registers(const std::shared_ptr<rmw_request_id_t> request_header, std::shared_ptr<RegisterValues::Request>req, std::shared_ptr<RegisterValues::Response> res);
